...
import { Code, Database, Globe, Palette, Cpu, Zap, Microchip, MonitorSmartphone } from "lucide-react";
...
export default function SkillCard({ id, name, domain, description, icon, progress }: SkillCardProps) {
